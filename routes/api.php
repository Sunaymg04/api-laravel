...
Route::get('/plan_estudio/vicedecano/solicitudes', [PlanEstudioController::class, 'solicitudesVicedecano']);
Route::get('/plan_estudio/vicedecano/historial', [PlanEstudioController::class, 'historialSolicitudesVicedecano']);
...
Route::post('/plan_estudio/{id}/vicedecano/aprobar', [PlanEstudioController::class, 'aprobarVicedecano']);
Route::post('/plan_estudio/{id}/vicedecano/cancelar', [PlanEstudioController::class, 'cancelarVicedecano']);
